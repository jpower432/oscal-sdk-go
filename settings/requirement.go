...
// RequirementSettings represents a specific implementation for a requirement
// for all mapped RuleSets. This is the representation the OSCAL Implemented Requirement
// level.
...
// NewRequirementSettings returns an initialized RequirementSettings from an
// OSCAL Implemented Requirement.
func NewRequirementSettings(implementedReq oscalTypes.ImplementedRequirementControlImplementation) RequirementSettings {
...
func (i *RequirementSettings) ContainsRule(set extensions.RuleSet) bool {
	return i.mappedRules.Has(set.Rule.ID)
}
